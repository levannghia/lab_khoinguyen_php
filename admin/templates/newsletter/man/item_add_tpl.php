                ...
                <div class="form-group-category row">
                    ...
                    <?php if(isset($config['newsletter'][$type]['kichthuoc']) && $config['newsletter'][$type]['kichthuoc'] == true) { ?>
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" name="data[kichthuoc]" id="kichthuoc" placeholder="Kích thước" value="<?=@$item['kichthuoc']?>">
                        </div>
                    <?php } ?>
                    <?php if(isset($config['newsletter'][$type]['soluong']) && $config['newsletter'][$type]['soluong'] == true) { ?>
                        <div class="form-group col-md-4">
                            <label for="soluong">Số lượng   :</label>
                            <input type="text" class="form-control" name="data[soluong]" id="soluong" placeholder="Số lượng " value="<?=@$item['soluong']?>">
                        </div>
                    <?php } ?>
                </div>
