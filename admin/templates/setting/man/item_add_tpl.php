		...
		<div class="card card-primary card-outline text-sm">
			...
			<div class="card-body">
				...
				<div class="row">
					...
					<?php } ?>
					<?php if(isset($config['setting']['slogan_title']) && $config['setting']['slogan_title'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							<label for="slogan_title">Slogan tiêu đề:</label>
							<input type="text" class="form-control" name="data[options][slogan_title]" id="slogan_title" placeholder="Slogan tiêu đề" value="<?=$options['slogan_title']?>">
						</div>
					<?php } ?>
					
					<?php if(isset($config['setting']['mst']) && $config['setting']['mst'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							<label for="mst">Mã số thuế:</label>
							<input type="text" class="form-control" name="data[options][mst]" id="mst" placeholder="Mã số thuế" value="<?=$options['mst']?>">
						</div>
					<?php } ?>
				</div>
