...
<head>
	...
	<link href="assets/images/logosota.png" rel="shortcut icon" type="image/x-icon" />
	...
	<script type="text/javascript">
		CKEDITOR.editorConfig = function( config ) {
			...
			[
				...
				'<?=$config_base?>assets/css/fonts.css'
			];
			config.font_names = 'Muli/font1;Oswald/font2;SVN Avo/font3;' + config.font_names;
