<?php
    ...
    $config['group'] = array(
        "Bảo hành" => array(
            "news" => array("bao-hanh","the-bao-hanh"),
            "static" => array("bao-hanh"),
            "photo" => array("bao-hanh"),
        ),
		"Bảo hành Lava" => array(
            "news" => array("the-bao-hanh-lava"),
           // "static" => array("bao-hanh-lava"),
            "photo" => array("bao-hanh-lava"),
        ),
		"Bảo hành Cercon" => array(
            "news" => array("the-bao-hanh-cercon"),
           // "static" => array("bao-hanh-cercon"),
            "photo" => array("bao-hanh-cercon"),
        )
    );
    ...
    $config['seopage']['page'] = array(
        "san-pham" => "Sản phẩm",
        "dich-vu" => "Dịch vụ",
        "thu-vien-anh" => "Thu viện ảnh",
        "bao-hanh" => "Bảo hành",
		//"bao-hanh-lava" => "Bảo hành Lava",
        "tin-tuc" => "Tin tức",
        "lien-he" => "Liên hệ",
    );
    ...
    $config['setting']['slogan_title'] = true;
    $config['setting']['diachi'] = true;
    $config['setting']['copyright'] = true;
    $config['setting']['mst'] = false;
