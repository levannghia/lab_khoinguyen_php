<?php
	...
	$requick = array(
		...
		array("tbl"=>"news","field"=>"id","source"=>"news","com"=>"bao-hanh","type"=>"bao-hanh",'menu'=>true),
		array("tbl"=>"news","field"=>"id","source"=>"news","com"=>"bao-hanh-lava","type"=>"bao-hanh-lava",'menu'=>true),
		array("tbl"=>"news","field"=>"id","source"=>"news","com"=>"bao-hanh-cercon","type"=>"bao-hanh-cercon",'menu'=>true),
	...
	switch($com)
	{
		...
		case 'bao-hanh-lava':
			...
			$seo->setSeo('type',isset($_GET['id']) ? "article" : "object");
			$type = $com;
			$title_crumb = 'Bảo hành Lava';
			break;	
		case 'bao-hanh-cercon':
			$source = "cercon";
			$template = "cercon/cercon";
			$seo->setSeo('type',isset($_GET['id']) ? "article" : "object");
			$type = $com;
			$title_crumb = 'Bảo hành Cercon';
			break;	
		case 'tin-tuc':
			$source = "news";
			$template = isset($_GET['id']) ? "news/news_detail" : "news/news";
