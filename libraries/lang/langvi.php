...
define("nhanmaytheoyeucau","Nhận may theo yêu cầu");
define("chinhsachsi","Chính sách sỉ");
define("jeannam","Jean Nam");
define("album","Album hình ảnh");
define("jeannu","Jean Nữ");
define("gioithieu","Giới thiệu");
define("tintuc","Tin tức");
define("lienhe","Liên hệ");
define("motasanpham","Mô tả");
define("nguyenlieu","Nguyên liệu");
define("sanphamchotom","Sản phẩm cho tôm");
define("tuvankythuat","Tư vấn kỹ thuật");
define("sanpham","Tất cả sản phẩm");
define("duan","Dự án");
define("luotxem","Lượt xem");
define("banggia","Bảng giá");
define("huongdandathang","Hướng dẫn đặt hàng");
...
define("daotaohocvien","Đào tạo học viên");
define("hethong","Hệ thống");
define("nhuongquyen","Nhượng quyền");
define("view","View");
define("congtrinh","Công trình");

define("kientruc","Kiến trúc");
define("thicongxaydung","Thi công xây dựng");
define("baogia","Báo giá");
define("maunhaxuong","Mẫu nhà xưởng");
define("chothuenhaxuong","Cho thuê nhà xưởng");
